  ...
  firebase.auth().onAuthStateChanged(firebaseUser => {
    if (firebaseUser){
      ...
      if(firebaseUser.email == "ltctmsapp2018@gmail.com"){
        ...
        window.location.href = "https://browserteam.firebaseio.com/Backend/Policy.html"
...
function policyPopup(){
  ...
  window.location.href = "https://browserteam.firebaseio.com/Frontend/01Aboutus2.html";
}
